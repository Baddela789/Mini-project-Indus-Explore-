...
<body class="aboutbody">
        <nav>
            <img src="ielogo.png" class="logo" alt="Logo" title="FirstFlight Travels">
    ...
    <section class="about">
           <div class="main">
            <img src="ie.png" alt="Travel">
            <div class="abt-text">
                <h1>About <span>Us</span></h1>
                <p>IndusExplore is a Industrial Visit Travel Website project developed by B.Nandini using HTML, CSS, JavaScript, Bootstrap, Mysql, Php.</p>
